      ...
      <div className="container">
        ...
        <div className="testimonials-content">
          ...
          <div className="testimonials-slider" id="testimonialSlider">
                ...
                <div key={t.id} className="testimonial-item">
                  <div className="testimonial-card">
                    <div className="testimonial-rating">
                      {[...Array(5)].map((_, i) => (
                        <i key={i} className={i < Math.floor(t.rating) ? "fas fa-star" : i < t.rating ? "fas fa-star-half-alt" : "far fa-star"}></i>
                      ))}
                    </div>
            ...
            {/* Nav Arrows & Dots would go here, omitting for brevity or handling in script.js logic if needed */}
          </div>
        </div>
      </div>
    </section>
