...
const Skills = () => {
  const technicalSkills = [
    ...
    { name: 'Android', percent: '80%', icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/android/android-original.svg" },
    { name: 'Git', percent: '85%', icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" },
    { name: 'Java', percent: '85%', icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" },
